 ...
 */
public class WifiCheckerLookForWifi implements Runnable {
    ...
    public WifiCheckerLookForWifi(Context currentContext, Intent nextIntent, ArrayList<String> macAdresses){
